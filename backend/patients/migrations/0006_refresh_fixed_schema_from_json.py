...
def refresh_fixed_schema_from_json(apps, schema_editor):
    ...
    template_name = schema_data.get('sheet') or 'Template'
    source_file_name = schema_data.get('workbook') or 'Template_Patients_HD.xlsx'
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('patients', '0005_update_decimal_field_types'),
    ]

    operations = [
        migrations.RunPython(refresh_fixed_schema_from_json, noop_reverse),
    ]
