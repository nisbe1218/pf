...
def estimate_route(technical_profile):
    ...
    if clinical_complexity_score >= 6 or rows > 300 or columns > 40 or missing_pct >= 10 or duplicate_rows > 0 or outlier_total > 5:
        return {
            ...
            'reason': 'Dataset medical complexe ou ambigu: modele avancé priorisé.',
            'primary_model': os.environ.get('OLLAMA_ADVANCED_MODEL', os.environ.get('OLLAMA_PREPROCESS_MODEL', os.environ.get('OLLAMA_MODEL', 'qwen2.5:14b'))),
    ...
    return {
        ...
        'primary_model': os.environ.get('OLLAMA_BALANCED_MODEL', os.environ.get('OLLAMA_PREPROCESS_MODEL', os.environ.get('OLLAMA_MODEL', 'qwen2.5:14b'))),
